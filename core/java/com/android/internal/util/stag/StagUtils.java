...
// Omni Switch Constants
   ...
   // Clear notifications
    ...
    public static boolean shouldSetNavbarHeight(Context context) {
        ...
        boolean twoThreeButtonEnabled = StagUtils.isThemeEnabled("com.android.internal.systemui.navbar.twobutton") ||
                StagUtils.isThemeEnabled("com.android.internal.systemui.navbar.threebutton");
