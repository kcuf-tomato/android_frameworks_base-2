...
class ThemeOverlayManager {
    ...
    ThemeOverlayManager(OverlayManager overlayManager, Executor executor,
        ...
        mTargetPackageToCategories.put(SYSUI_PACKAGE,
                Sets.newHashSet(OVERLAY_CATEGORY_ICON_SYSUI, OVERLAY_CATEGORY_PRIMARY));
        mTargetPackageToCategories.put(SETTINGS_PACKAGE,
                Sets.newHashSet(OVERLAY_CATEGORY_ICON_SETTINGS, OVERLAY_CATEGORY_PRIMARY));
        ...
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_PRIMARY, SYSUI_PACKAGE);
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_ICON_SETTINGS, SETTINGS_PACKAGE);
	mCategoryToTargetPackage.put(OVERLAY_CATEGORY_PRIMARY, SETTINGS_PACKAGE);
